function enableAddOn(){
  ...
  let wordLengthBufferKey = document.getElementById('wordLengthBufferKey').value;
  ...
  browser.runtime.sendMessage({message: 'ActivateListeners', modelLocation: modelLocation, wordLength: wordLength, wordLengthBufferKey: wordLengthBufferKey, letterKeysLocation: letterKeysLocation, typingBuffer: typingBuffer, revertTimer: revertTimer, firstToken: firstToken});
}
...
if (localStorage.getItem('modelLocation')){
  ...
  document.getElementById('wordLengthBufferKey').value = localStorage.getItem('wordLengthBufferKey');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('toggleSwitch').addEventListener('change', function() {
      if (this.checked){
        ...
        localStorage.setItem("wordLengthBufferKey", document.getElementById('wordLengthBufferKey').value);
